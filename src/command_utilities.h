...
// TODO change
#define OBC_HK_AUTO_DATA_COL_ENABLED_EEPROM_ADDR    0x100
#define OBC_HK_AUTO_DATA_COL_PERIOD_EEPROM_ADDR     0x104
#define EPS_HK_AUTO_DATA_COL_ENABLED_EEPROM_ADDR    0x110
#define EPS_HK_AUTO_DATA_COL_PERIOD_EEPROM_ADDR     0x114
#define PAY_HK_AUTO_DATA_COL_ENABLED_EEPROM_ADDR    0x120
#define PAY_HK_AUTO_DATA_COL_PERIOD_EEPROM_ADDR     0x124
#define PAY_OPT_AUTO_DATA_COL_ENABLED_EEPROM_ADDR   0x130
#define PAY_OPT_AUTO_DATA_COL_PERIOD_EEPROM_ADDR    0x134
