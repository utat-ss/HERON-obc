...
#define MEM_PAY_HK_END_ADDR         0x37FFFFUL
#define MEM_PAY_OPT_START_ADDR      0x380000UL
#define MEM_PAY_OPT_END_ADDR        0x47FFFFUL
#define MEM_PRIM_CMD_LOG_START_ADDR 0x480000UL
